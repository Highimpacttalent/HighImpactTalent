  ...
  const fetchApplications = async (
    ...
    try {
      ...
      if (
        ...
        thisFetchId === latestFetchId.current
      ) {
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Box
            sx={{
              display: "flex",
              justifyContent:
                selectedApplications.size > 0 ? "space-between" : "flex-end",
              alignItems: "center",
              mb: 2,
              px: 1,
            }}
          ...
          {filteredApps.length > 0 && (
            ...
            >
              ...
              {!isMobile ? (
                ...
                >
                  {/* Row 1 - Select All + Visible Profiles */}
                  <Box
                    sx={{
                      display: "flex",
                      ...
                      <Button
                        ...
                        onClick={() =>
                          openConfirmDialog(
                            "advance",
                            "Advance Selected",
                            `Move ${selectedApplications.size} candidate(s) to Shortlisted?`
                          )
                        }
                        sx={{
                          flex: 1,
                      ...
                      <Button
                        ...
                        onClick={() =>
                          openConfirmDialog(
                            "reject",
                            "Reject Selected",
                            `Reject ${selectedApplications.size} candidate(s)?`
                          )
                        }
                        sx={{
                          flex: 1,
