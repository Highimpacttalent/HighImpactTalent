...
import WaitlistPage from "./pages/AuthForm/Waitlist.jsx";
    ...
    <main className="bg-[#f3f4f6] font-[Poppins] tracking-tighter ">
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route
            path="/job-detail/:id/screening-questions"
            element={<ScreeningView />}
          ></Route>
          <Route
          ...
          <Route
            ...
            element={<RecruiterSchedule />}
          ></Route>
          <Route element={<PaymentProtectedRoute />}>
            <Route path={"/resumesearch"} element={<ResumeSearch />}></Route>
            <Route
              path="/resumesearch/viewresume/:resumeId"
              element={<ViewResumeProfile />}
            />
          </Route>
